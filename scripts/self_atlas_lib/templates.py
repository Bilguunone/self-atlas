...
TEMPLATE_LIBRARY = (
    ...
    TemplateSpec(
        ...
        (
            ...
            section("Contact And Logistics", "- Phone:", "- Email:", "- Address:", "- Handles:", "- Emergency/contact notes:"),
    ...
    TemplateSpec(
        ...
        (
            ...
            section("Contact And Logistics", "- Phone:", "- Email:", "- Address:", "- Emergency/contact notes:"),
    ...
    TemplateSpec(
        ...
        (
            ...
            section("Contact And Logistics", "- Phone:", "- Email:", "- Address:", "- Handles:", "- Work/admin notes:"),
            section("Strengths"),
    ...
    TemplateSpec(
        ...
        (
            ...
            section("Contact And Logistics", "- Phone:", "- Email:", "- Address:", "- Important practical notes:"),
    ...
    TemplateSpec(
        ...
        "{{thing}}",
        "private",
        ("self-atlas/things", "self-atlas/thing"),
        (
            section("Snapshot"),
            section(
                "Status",
                "- State: bought | own | want | considering | borrowed | sold | returned",
                "- Bought date:",
                "- Price and currency:",
                "- Source or store:",
                "- Receipt or order link:",
            ),
            section("Why It Matters"),
            section("Taste Signal"),
            section("Life It Enables"),
            section("Usage Pattern"),
            section("Wanting Notes"),
            section("Money Notes"),
            section("Related People And Projects"),
            section("Open Questions"),
        ),
    ),
    TemplateSpec(
    ...
    TemplateSpec(
        ...
        "private",
        ("self-atlas/credentials", "self-atlas/logistics"),
        (
            section("Account Or Credential"),
            section("Purpose"),
            section(
                "Access Context",
                "- Account/service:",
            ...
            section("Do Not Store Here", "- Raw passwords", "- API keys", "- Private tokens", "- Recovery codes", "- Exact card or bank numbers"),
            section("Related People Or Projects"),
            section("Open Questions"),
        ),
    ),
    TemplateSpec(
